...
const formUrlencodedRequest = axios.create({
  baseURL,
...
export const loginApi = data => formUrlencodedRequest.post('/interface/web/UserLogin', data);
export const getSiteApi = () => formUrlencodedRequest.get('/interface/web/GetSite');
// favorite
...
// 
export const getAllApi = data => formUrlencodedRequest.post('/interface/web/WebLogin', data);
export const getStoreApi = data => formUrlencodedRequest.post('/interface/web/getStore', data);
export const getCopyRightApi = data => formUrlencodedRequest.post('/interface/web/GetCopyRight', data);
export const getCustomerServiceApi = data => formUrlencodedRequest.post('/interface/web/GetCustomerService', data);
// 
export const getHomePageApi = data => formUrlencodedRequest.post('/interface/web/GetHomePage', data);
export const getCategoryApi = data => formDataRequest.post('/interface/web/GetWebSubCategory', data);
export const getContactApi = data => formUrlencodedRequest.post('/interface/web/GetWebContact', data);
...
export const rePayApi = data => formUrlencodedRequest.post('/LineMK/Line/RePayConfirm', data);
export const searchMartDeliveryApi = data => formDataRequest.post('/interface/store/QueryLogisticsInfo', data);
export const send_verify_codeApi = data => formUrlencodedRequest.post('/interface/WebMember/SendValidateMessage', data);
...
export const post_logoutApi = data => formUrlencodedRequest.post('/interface/WebMember/MemberLogout', data);
...
// shopping
export const getCategoriesApi = data => formUrlencodedRequest.post('/interface/store/GetCategory', data);
export const getProductsApi = data => formUrlencodedRequest.post('/interface/store/storeLogin', data);