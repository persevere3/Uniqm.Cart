      ...
      <div class="sidebar" :class="{sidebar_slideout : is_slideout}">
        ...
        <div class="other">
          ...
          <ul>
            ...
            <li @click.stop="is_favorite_active = !is_favorite_active; is_carts_active = false" tabindex="0" @blur="is_favorite_active = false">
              我的最愛
              <i class="fas fa-heart"></i>
            </li>
            <li @click.stop="carts.length ? is_carts_active = !is_carts_active : pushTo_cart(); is_favorite_active = false" tabindex="0" @blur="is_carts_active = false">
              購物車
              <i class="fa fa-shopping-cart" aria-hidden="true"></i>
            </li>
